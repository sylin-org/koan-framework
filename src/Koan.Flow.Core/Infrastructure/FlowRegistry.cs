...
namespace Koan.Flow.Infrastructure;
...
public static class FlowRegistry
{
    ...
    /// <summary>
    /// Returns the parent Flow entity type and key path for a value-object type (deriving from <see cref="Koan.Flow.Model.FlowValueObject{T}"/>),
