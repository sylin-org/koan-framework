...
internal static class AdminWebBootstrap
{
    ...
    internal static void Report(Koan.Core.Provenance.ProvenanceModuleWriter module, IConfiguration cfg, IHostEnvironment env)
    {
