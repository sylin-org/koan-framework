...
/// <summary>
/// Stable names and configuration keys for Sora.Messaging.Core.
/// Tunable defaults should live in Options classes, not here.
/// </summary>
public static class Constants
{
    public static class Configuration
    {
        ...
        public const string Buses = Section + ":Buses";
        ...
        {
            public const string Section = "Sora:Messaging:Inbox";
        ...
        {
            public const string Section = "Sora:Messaging:Discovery";
