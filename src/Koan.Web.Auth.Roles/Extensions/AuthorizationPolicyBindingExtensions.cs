...
public static class AuthorizationPolicyBindingExtensions
{
    ...
    public static IServiceCollection AddKoanRolePolicies(this IServiceCollection services, System.Action<RolePolicyOptions>? configure = null)
    {
        ...
        services.AddKoanWebCapabilityPolicies(p =>
        {
