...
public sealed class SoraAutoRegistrar : ISoraAutoRegistrar
{
    ...
    {
        var logger = services.BuildServiceProvider().GetService<Microsoft.Extensions.Logging.ILoggerFactory>()?.CreateLogger("Sora.Data.SqlServer.Initialization.SoraAutoRegistrar");
    logger?.Log(LogLevel.Debug, "Sora.Data.SqlServer SoraAutoRegistrar loaded.");
