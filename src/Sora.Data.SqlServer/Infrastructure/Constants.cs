namespace Sora.Data.SqlServer.Infrastructure;
...
public static class Constants
{
    public static class Configuration
    {
        ...
        {
            public const string Section = "Sora:Data:SqlServer";
            public const string AltSection = "Sora:Data:Sources:Default:sqlserver";
