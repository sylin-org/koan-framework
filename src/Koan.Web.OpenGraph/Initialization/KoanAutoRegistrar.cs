...
/// Koan.Web, so it is ordered <c>[After]</c> the Koan.Web core registrar, matching the convention the
...
/// constraint: per <c>RegistrarOrdering</c>, if Koan.Web is not loaded the target is simply ignored.
/// </remarks>
...
public sealed class KoanAutoRegistrar : IKoanAutoRegistrar
{
    ...
    public string ModuleName => "Koan.Web.OpenGraph";
