...
public interface IBackupProgressNotifier
{
    ...
    /// </summary>
    Task NotifyBackupProgress(string operationId, BackupProgressInfo progress);

    /// <summary>
    /// Log restore progress update (no-op - clients poll for updates)
    /// </summary>
    Task NotifyRestoreProgress(string operationId, RestoreProgressInfo progress);

    /// <summary>
    /// Log backup operation completion (no-op - clients poll for updates)
    /// </summary>
    Task NotifyBackupCompleted(string operationId, Data.Backup.Models.BackupManifest result);

    /// <summary>
    /// Log restore operation completion (no-op - clients poll for updates)
    /// </summary>
    Task NotifyRestoreCompleted(string operationId, RestoreResult result);

    /// <summary>
    /// Log operation failure (no-op - clients poll for updates)
    /// </summary>
    Task NotifyOperationFailed(string operationId, string errorMessage);

    /// <summary>
    /// Log operation cancellation (no-op - clients poll for updates)
    /// </summary>
    Task NotifyOperationCancelled(string operationId);

    /// <summary>
    /// Log system status update (no-op - clients poll for updates)
    /// </summary>
    Task NotifySystemStatus(BackupSystemStatusResponse status);
}
...
public class PollingBackupProgressNotifier : IBackupProgressNotifier
{
    ...
    public Task NotifyBackupProgress(string operationId, BackupProgressInfo progress)
    {
    ...
    public Task NotifyRestoreProgress(string operationId, RestoreProgressInfo progress)
    {
    ...
    public Task NotifyBackupCompleted(string operationId, Data.Backup.Models.BackupManifest result)
    {
    ...
    public Task NotifyRestoreCompleted(string operationId, RestoreResult result)
    {
    ...
    public Task NotifyOperationFailed(string operationId, string errorMessage)
    {
    ...
    public Task NotifyOperationCancelled(string operationId)
    {
    ...
    public Task NotifySystemStatus(BackupSystemStatusResponse status)
    {
