...
internal static class Planner
{
    ...
    // Precedence: explicitPort (from CLI) > .Koan manifest AssignedPublicPort > generated/attribute default > deterministic [30000,50000].
    ...
    {
        // Supported files (first found wins): Koan.orchestration.yml|yaml|json under project root
        var cwd = Directory.GetCurrentDirectory();
