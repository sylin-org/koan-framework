...
/// <summary>
/// Transport envelope for dynamic Canon entities. Similar to TransportEnvelope but uses
/// a dictionary payload instead of strongly typed payload. The generic type parameter
/// informs the receptor which Canon intake queue to route the dynamic object to.
/// </summary>
/// <typeparam name="T">The target Canon entity type (used for routing only)</typeparam>
