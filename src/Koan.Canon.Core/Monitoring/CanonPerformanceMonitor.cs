...
namespace Koan.Canon.Core.Monitoring;

/// <summary>
/// Performance monitoring service for Canon operations with metrics collection and reporting.
/// </summary>
public class CanonPerformanceMonitor
{
    private readonly ILogger<CanonPerformanceMonitor> _logger;
    private CancellationTokenSource? _reportingCancellation;

    public CanonPerformanceMonitor(ILogger<CanonPerformanceMonitor> logger)
    {
        _logger = logger;
    }
    ...
    /// <summary>
    /// Records performance metrics for a Canon operation.
    /// </summary>
