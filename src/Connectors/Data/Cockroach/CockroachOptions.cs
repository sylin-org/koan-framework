...
public sealed class CockroachOptions : IAdapterOptions
{
    [Required]
    public string ConnectionString { get; set; } = "auto"; // DX-first: auto-detect by default
    // CockroachDB truncates identifiers at 63 bytes, so FullNamespace overflows for non-trivial namespaces
