...
/// auth, page-size) lives on <see cref="SearchEngineVectorOptions"/>; this concrete class adds only the
/// per-package binding members (<see cref="ConnectionString"/>, <see cref="Readiness"/>).
/// </summary>
public sealed class ElasticSearchOptions : SearchEngineVectorOptions, IAdapterOptions
{
    [Required]
