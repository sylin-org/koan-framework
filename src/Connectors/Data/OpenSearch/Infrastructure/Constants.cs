...
internal static class Constants
{
    ...
    {
        internal const string Name = "opensearch";
        internal const int Priority = 20;
        internal static readonly string[] Aliases = ["open-search", "os"];
    }
    ...
    internal static class Wire
    {
        ...
        internal const string Engine = "koan_engine";
    ...
    internal const string HealthLog = "data.opensearch.health";
}
