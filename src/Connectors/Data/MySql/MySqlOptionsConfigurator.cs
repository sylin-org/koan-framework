...
internal sealed class MySqlOptionsConfigurator : AdapterOptionsConfigurator<MySqlOptions>
{
    private readonly IServiceDiscoveryCoordinator? _discovery;
    protected override string ProviderName => "MySql";

    public MySqlOptionsConfigurator(
        IConfiguration configuration,
        ILogger<MySqlOptionsConfigurator> logger,
    ...
    protected override void ConfigureProviderSpecific(MySqlOptions options)
    {
