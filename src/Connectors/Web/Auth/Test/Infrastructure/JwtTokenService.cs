...
/// it and forge a "valid" token. Asymmetric signing means a verifier (the inbound validator /
...
public sealed class JwtTokenService
{
    ...
    private const string Algorithm = EcdsaKeyRing.Algorithm; // "ES256"
    ...
    /// <summary>The public half of the signing key as a JWK, for the OIDC JWKS endpoint — public-only by construction.</summary>
    public JsonWebKey GetPublicJwk() => EcdsaKeyRing.ToPublicJwk(_ring.Active);
