...
/// </list>
/// <para>
/// <b>Failure semantics:</b> bootstrap, sign-in, challenge, and access-denied exceptions propagate. A
/// validate-principal exception rejects the cookie principal. Sign-out is the only best-effort event: failures are
/// logged so local session removal can still finish. <see cref="System.OperationCanceledException"/> always
/// propagates.
/// </para>
/// <para>
