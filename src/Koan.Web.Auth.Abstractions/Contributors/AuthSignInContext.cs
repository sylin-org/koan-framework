...
/// Outer middleware can read the functional Web Auth sign-in-rejected marker on
/// <see cref="HttpContext.Items"/> to translate the marker into a redirect or distinct response.
/// Contributors should call <see cref="Reject(string)"/> for an expected business rejection. Unexpected exceptions
/// fail the sign-in closed in the functional dispatcher.
/// </para>
/// </remarks>
