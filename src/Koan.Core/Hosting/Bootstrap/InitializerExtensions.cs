...
public static class InitializerExtensions
{
    ...
    /// </summary>
    /// <param name="initializer">The IKoanInitializer instance</param>
    /// <returns>True if this initializer type has already been invoked</returns>
    public static bool HasBeenInvoked(this IKoanInitializer initializer)
    {
    ...
    public static bool InitializeOnce(this IKoanInitializer initializer, 
