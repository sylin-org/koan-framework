...
/// <summary>
/// Base class for Koan background services with logging and health checks
/// </summary>
public abstract class KoanBackgroundServiceBase : BackgroundService, IKoanBackgroundService, IHealthContributor
{
...
/// </summary>
public abstract class KoanFluentServiceBase : KoanBackgroundServiceBase, IKoanPokableService
{
...
public abstract class KoanPokablePeriodicServiceBase : KoanFluentServiceBase, IKoanPeriodicService
{
    ...
    protected KoanPokablePeriodicServiceBase(ILogger logger, IConfiguration configuration)
        : base(logger, configuration) { }
...
/// </summary>
public abstract class KoanStartupServiceBase : KoanFluentServiceBase, IKoanStartupService
{
    protected KoanStartupServiceBase(ILogger logger, IConfiguration configuration)
        : base(logger, configuration) { }
