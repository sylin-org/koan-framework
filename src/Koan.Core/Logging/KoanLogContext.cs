...
/// This follows Koan's auto-registration pattern and separation of concerns principle.
/// </summary>
public sealed class KoanLogContext
{
    ...
    {
        return new KoanContextLogger(baseLogger, this);
    }
...
/// This provides the semantic developer experience Koan aims for.
/// </summary>
internal sealed class KoanContextLogger : ILogger
{
    private readonly ILogger _baseLogger;
    private readonly KoanLogContext _context;

    public KoanContextLogger(ILogger baseLogger, KoanLogContext context)
    {
