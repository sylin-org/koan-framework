...
internal static class SoraWebHelpers
{
    ...
    public static object GetRepository(IServiceProvider sp, Sora.Data.Core.IDataService data, Type entityType, Type keyType)
    {
        var mi = typeof(Sora.Data.Core.IDataService).GetMethod("GetRepository")!;
