...
/// <summary>
/// Template for generating database adapter scaffolding.
/// Provides connection management, health checks, and basic CRUD patterns.
/// </summary>
public class DatabaseAdapterTemplate : IAdapterTemplate
{
    public string Name => "Database Adapter";
    public string Description => "Generates a database adapter with connection management, health checks, and basic patterns";
    public ServiceType ServiceType => ServiceType.Database;
...
{{
    ...
    public override AdapterCapabilities Capabilities => AdapterCapabilities.Create()
        ...
        .WithData(ExtendedQueryCapabilities.None); // Configure based on database capabilities
    ...
    {{
        ...
        // Example: _connection = new SomeDbConnection(connectionString);
