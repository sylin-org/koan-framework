...
/// <summary>
/// Optional capability implemented by a <see cref="Koan.Core.KoanModule"/> that contributes
...
/// </summary>
/// <remarks>
/// A functional assembly keeps one module. Implement this interface on that module when its
/// referenced capability also needs to describe Aspire resources:
///
/// <code>
/// public sealed class PostgresDataModule : KoanModule, IKoanAspireResources
/// {
///     public override void Register(IServiceCollection services) { /* DI registration */ }
