...
/// <summary>
/// Koan.Orchestration.Aspire module that provides mode detection
/// and self-orchestration capabilities based on "Reference = Intent"
/// </summary>
public sealed class AspireModule : KoanModule
{
    private static readonly KoanLog.KoanLogScope Log = KoanLog.For<AspireModule>();
    ...
    private static class LogActions
    {
        ...
        public const string ModeDetected = "module.mode";
        public const string ModeCase = "module.mode.case";
    }
}
