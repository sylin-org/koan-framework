...
public class DataCleanupService : SoraPokablePeriodicServiceBase
{
...
/// </summary>
[ServiceEvent(Sora.Core.Events.SoraServiceEvents.Translation.Started, EventArgsType = typeof(TranslationEventArgs))]
[ServiceEvent(Sora.Core.Events.SoraServiceEvents.Translation.Completed, EventArgsType = typeof(TranslationEventArgs))]
[ServiceEvent(Sora.Core.Events.SoraServiceEvents.Translation.Failed, EventArgsType = typeof(TranslationErrorArgs))]
public class TranslationService : SoraFluentServiceBase
{
    ...
    await EmitEventAsync(Sora.Core.Events.SoraServiceEvents.Translation.Started, new TranslationEventArgs 
        { 
        ...
        try
        {
            ...
            await EmitEventAsync(Sora.Core.Events.SoraServiceEvents.Translation.Completed, new TranslationEventArgs 
            { 
                FileId = options.FileId, 
                From = options.From, 
                To = options.To 
        ...
        {
            await EmitEventAsync(Sora.Core.Events.SoraServiceEvents.Translation.Failed, new TranslationErrorArgs 
            { 
                FileId = options.FileId, 
                Error = ex.Message 
            });
...
/// </summary>
[SoraStartupService(StartupOrder = 1, TimeoutSeconds = 60)]
...
/// </summary>
public class NotificationService : SoraFluentServiceBase
{
    ...
    await SoraServices.On<TranslationService>(Sora.Core.Events.SoraServiceEvents.Translation.Completed).Do<TranslationEventArgs>(async args =>
            {
