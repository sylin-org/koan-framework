...
public sealed class KoanAutoRegistrar : IKoanAutoRegistrar
{
    ...
    public void Describe(Koan.Core.Hosting.Bootstrap.BootReport report, IConfiguration cfg, IHostEnvironment env)
    {
        ...
        var endpoint = Configuration.Read(cfg, "Koan:Data:Weaviate:Endpoint", null) ?? "http://localhost:8085";
    ...
    private static bool Probe(string baseUrl, TimeSpan timeout)
    {
        try
        {
            ...
            System.Diagnostics.Debug.WriteLine($"[Koan.Data.Weaviate] Probe GET {readyUrl}");
            ...
            System.Diagnostics.Debug.WriteLine($"[Koan.Data.Weaviate] Probe fallback GET {readyV1Url} (prior {(int)ready.StatusCode})");
            ...
            System.Diagnostics.Debug.WriteLine($"[Koan.Data.Weaviate] Probe schema GET {schemaUrl} (prior {(int)readyV1.StatusCode})");
