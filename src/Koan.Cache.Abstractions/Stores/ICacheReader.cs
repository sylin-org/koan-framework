...
{
    ValueTask<CacheFetchResult> Get(CacheKey key, CacheEntryOptions options, CancellationToken ct);
    ...
    ValueTask<bool> Exists(CacheKey key, CacheEntryOptions options, CancellationToken ct);
}
