...
/// so the derivation is unit-testable without a host. An explicit <paramref name="overridePosture"/> wins when
...
/// here. With no override, the ASP.NET rule verbatim: a positive <paramref name="isDevelopment"/> ⇒
