...
/// <remarks>
/// <para>
/// The default implementation (<see cref="Infrastructure.DefaultCurrentUserProjector"/>) surfaces the rich shape:
...
/// </para>
/// <para>
/// Replace via <c>services.AddSingleton&lt;ICurrentUserProjector, MyProjector&gt;()</c> AFTER
/// <c>services.AddKoanWebAuth()</c> — the framework registers the default with
/// <c>TryAddSingleton</c> so a host registration wins.
/// </para>
/// </remarks>
