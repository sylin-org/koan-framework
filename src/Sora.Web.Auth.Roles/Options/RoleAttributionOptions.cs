namespace Sora.Web.Auth.Roles.Options;

public sealed class RoleAttributionOptions
{
    public const string SectionPath = "Sora:Web:Auth:Roles";
    ...
    {
        public string[] Roles { get; set; } = new[] { "roles", "role", "groups", Infrastructure.RoleClaimConstants.SoraRole, Infrastructure.RoleClaimConstants.SoraRoles };
        public string[] Permissions { get; set; } = new[] { Infrastructure.RoleClaimConstants.SoraPermission, "permissions", "scope" };
    }
