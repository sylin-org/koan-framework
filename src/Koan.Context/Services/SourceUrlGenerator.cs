...
/// <summary>
/// Generates source URLs (GitHub, GitLab, etc.) from file paths and git metadata
/// </summary>
public interface ISourceUrlGenerator
{
    /// <summary>
    /// Generates a direct URL to the file in the remote repository
    /// </summary>
...
/// <summary>
/// Implementation using git remote URL detection
/// </summary>
public sealed class SourceUrlGenerator : ISourceUrlGenerator
{
    private readonly ILogger<SourceUrlGenerator> _logger;
    private readonly Dictionary<string, RemoteUrlInfo> _remoteCache = new();

    public SourceUrlGenerator(ILogger<SourceUrlGenerator> logger)
    {
        _logger = logger;
    }
