...
/// <summary>
/// Koan.Web.Transformers boot module (ARCH-0086). Folds the former split between the nested
/// <c>TransformerStartupInitializer</c> (registration + deferred auto-discovery) and <c>KoanAutoRegistrar</c>
/// (AutoDiscover provenance) into one <see cref="KoanModule"/>. Id preserves the prior ModuleName so boot
/// reports are unchanged.
/// </summary>
public sealed class KoanWebTransformersModule : KoanModule
{
    public override string Id => "Koan.Web.Transformers";
