...
namespace Koan.Flow.Runtime.Dapr;
...
internal sealed class DaprFlowRuntime : IFlowRuntime
{
    ...
    {
        _log.LogInformation("Koan.Flow Dapr runtime active");
        return Task.CompletedTask;
    }

    public Task StopAsync(CancellationToken ct = default)
    { _log.LogInformation("Koan.Flow Dapr runtime stopped."); return Task.CompletedTask; }
