namespace Sora.Data.Postgres.Infrastructure;
...
public static class Constants
{
    public static class Configuration
    {
        ...
        {
            public const string Section = "Sora:Data:Postgres";
            public const string AltSection = "Sora:Data:Sources:Default:postgres";
