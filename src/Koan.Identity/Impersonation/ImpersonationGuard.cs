...
/// never destroy/escalate as them — so account deletion, role grants, and nested impersonation are blocked by
/// construction.
/// </summary>
public static class ImpersonationGuard
{
    ...
    /// Future authentication-factor mutation verbs join here only when a supported endpoint lands.
    /// </summary>
