...
/// </summary>
public sealed class KoanMcpOperationsAutoRegistrar : IKoanAutoRegistrar
{
    public string ModuleName => "Koan.Mcp.Operations";

    public string? ModuleVersion => typeof(KoanMcpOperationsAutoRegistrar).Assembly.GetName().Version?.ToString();
    ...
    public void Describe(ProvenanceModuleWriter module, IConfiguration configuration, IHostEnvironment environment)
    {
        ...
        module.Describe(ModuleVersion, line);
    }
