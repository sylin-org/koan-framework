...
public abstract class EntitySoftDeleteController<TEntity, TKey> : ControllerBase
    ...
    where TKey : notnull
{
    protected virtual string DeletedSet => SoraWebConstants.Sets.Deleted;
    ...
    [Authorize]
    [Sora.Web.Extensions.Authorization.RequireCapability(Sora.Web.Extensions.Capabilities.CapabilityActions.SoftDelete.ListDeleted)]
    [Produces("application/json")]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status401Unauthorized)]
    [ProducesResponseType(StatusCodes.Status403Forbidden)]
    [HttpGet("soft-delete/deleted")]
    public virtual async Task<ActionResult<IReadOnlyList<TEntity>>> GetDeleted([FromQuery] int page = 1, [FromQuery] int size = SoraWebConstants.Defaults.DefaultPageSize, CancellationToken ct = default)
    {
    ...
    /// <param name="ct">Cancellation token.</param>
    [Authorize]
    [Sora.Web.Extensions.Authorization.RequireCapability(Sora.Web.Extensions.Capabilities.CapabilityActions.SoftDelete.Delete)]
    ...
    /// <param name="ct">Cancellation token.</param>
    [Authorize]
    [Sora.Web.Extensions.Authorization.RequireCapability(Sora.Web.Extensions.Capabilities.CapabilityActions.SoftDelete.DeleteMany)]
    [Consumes("application/json")]
    [Produces("application/json")]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    ...
    /// <param name="ct">Cancellation token.</param>
    [Authorize]
    [Sora.Web.Extensions.Authorization.RequireCapability(Sora.Web.Extensions.Capabilities.CapabilityActions.SoftDelete.Restore)]
    [Consumes("application/json")]
    [Produces("application/json")]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    ...
    /// <param name="ct">Cancellation token.</param>
    [Authorize]
    [Sora.Web.Extensions.Authorization.RequireCapability(Sora.Web.Extensions.Capabilities.CapabilityActions.SoftDelete.RestoreMany)]
    [Consumes("application/json")]
    [Produces("application/json")]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
