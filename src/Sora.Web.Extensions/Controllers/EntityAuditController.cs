...
{
    protected virtual string AuditSet => SoraWebConstants.Sets.Audit;
    ...
    [Authorize]
    [Sora.Web.Extensions.Authorization.RequireCapability(Sora.Web.Extensions.Capabilities.CapabilityActions.Audit.Snapshot)]
    ...
    /// <param name="ct">Cancellation token.</param>
    [Authorize]
    [Sora.Web.Extensions.Authorization.RequireCapability(Sora.Web.Extensions.Capabilities.CapabilityActions.Audit.List)]
    [Produces("application/json")]
    ...
    /// <param name="ct">Cancellation token.</param>
    [Authorize]
    [Sora.Web.Extensions.Authorization.RequireCapability(Sora.Web.Extensions.Capabilities.CapabilityActions.Audit.Revert)]
