...
public static class BulkStageTransitionService
{
    ...
    public static async Task<int> TransitionRecordsBulk<T>(
        ...
        where T : class, Sora.Data.Abstractions.IEntity<string>
    {
    ...
    public static async Task<int> TransitionWithTypeConversion<TSource, TTarget>(
        ...
        string toStage,
        CancellationToken ct = default) 
        where TSource : class, Sora.Data.Abstractions.IEntity<string>
        where TTarget : class, Sora.Data.Abstractions.IEntity<string>
    {
