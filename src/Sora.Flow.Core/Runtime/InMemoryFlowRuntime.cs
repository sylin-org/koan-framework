...
internal sealed class InMemoryFlowRuntime : IFlowRuntime
{
    ...
    { _log.LogInformation("Sora.Flow InMemory runtime started."); return Task.CompletedTask; }
    public Task StopAsync(CancellationToken ct = default)
    { _log.LogInformation("Sora.Flow InMemory runtime stopped."); return Task.CompletedTask; }
