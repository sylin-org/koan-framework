...
Translate the outcome into Koan pieces, name the exact package, then confirm behavior in the linked
...
2. **Open the linked recipe before writing code** against a piece you have not used in this
...
3. **Prefer what the application already resolves.** Once a package is referenced, its own README is
...
| Outcome | Package | Recipe |
|---|---|---|
| Authentication and authorization | `Sylin.Koan.Web.Auth` | [Auth recipe](https://github.com/sylin-org/koan-framework/blob/v1.0.0/docs/guides/auth-howto.md) · [Authorization recipe](https://github.com/sylin-org/koan-framework/blob/v1.0.0/docs/guides/authorization-howto.md) |
...
| Media recipes and derivatives | `Sylin.Koan.Media.Core` · `Sylin.Koan.Media.Web` | [Recipe](https://github.com/sylin-org/koan-framework/blob/v1.0.0/docs/guides/media-recipes-howto.md) · [README](https://github.com/sylin-org/koan-framework/blob/v1.0.0/src/Koan.Media.Core/README.md) |
...
| Outcome | Package | Recipe |
|---|---|---|
| Model operations | `Sylin.Koan.AI` | [README](https://github.com/sylin-org/koan-framework/blob/v1.0.0/src/Koan.AI.Contracts/README.md) · [Reference](https://github.com/sylin-org/koan-framework/blob/v1.0.0/docs/reference/ai/index.md) |
...
| `[Embedding]` on an Entity, and `EntityAi` operations | `Sylin.Koan.Data.AI` — **not assessed** | [README](https://github.com/sylin-org/koan-framework/blob/v1.0.0/src/Koan.Data.AI/README.md) |
| Entity vector semantics | `Sylin.Koan.Data.Vector` | [README](https://github.com/sylin-org/koan-framework/blob/v1.0.0/src/Koan.Data.Vector.Abstractions/README.md) · [Reference](https://github.com/sylin-org/koan-framework/blob/v1.0.0/docs/reference/ai/vector.md) |
