...
$frontDoorRequirements = [ordered]@{
    'README.md' = @('Entity<Todo>', 'EntityController<Todo>', 'AddKoan()', 'Sylin.Koan.Templates', 'McpEntity', 'docs/capabilities/index.md', 'docs/guides/agent-skills.md', 'koan.lock.json')
