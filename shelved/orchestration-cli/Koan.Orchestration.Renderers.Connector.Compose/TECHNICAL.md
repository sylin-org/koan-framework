...
title: Koan.Orchestration.Renderers.Connector.Compose – Technical Reference
...
since: 0.6.3
packages: [Sylin.Koan.Orchestration.Renderers.Connector.Compose]
source: src/Koan.Orchestration.Renderers.Connector.Compose/
validation:
  date: 2025-09-29
  status: verified
---
