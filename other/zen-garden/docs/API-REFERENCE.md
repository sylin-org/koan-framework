...
- Creates encrypted pebble file (private key)
...
```bash
# Zen syntax
garden-rake place pebble --passphrase "my-secure-pass"
...
```json
{
  ...
  "data": {
    ...
    "stones": [],
    "tier": "garden-pond",
    "note": "Pond security not initialized. Run 'garden-rake place pebble' to secure your garden."
  }
}
```
