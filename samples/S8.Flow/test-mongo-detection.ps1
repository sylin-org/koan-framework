...
$env:SORA_DATA_MONGO_URLS = "mongodb://localhost:27017,mongodb://mongo:27017"
Write-Host "Setting SORA_DATA_MONGO_URLS=mongodb://localhost:27017,mongodb://mongo:27017"
