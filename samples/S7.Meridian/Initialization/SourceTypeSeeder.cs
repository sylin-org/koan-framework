            ...
            try
            {
                ...
                foreach (var seedType in sourceTypes)
                {
                    ...
                    if (existing == null)
                    {
                        ...
                        seededCount++;
                        Console.WriteLine($"[Meridian] Seeded SourceType: {seedType.Name} (v{seedType.Version})");
                    }
                    else
                    {
                        ...
                        if (needsUpdate)
                        {
                            ...
                            updatedCount++;
                            Console.WriteLine($"[Meridian] Updated SourceType: {existing.Name} to v{existing.Version}");
                        }
                    }
                }
