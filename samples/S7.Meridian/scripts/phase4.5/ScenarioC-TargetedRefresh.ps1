...
$sourcePrompts = @(
    @{ Prompt = "Vendor questionnaire responses capturing revenue, staffing, certifications, and capabilities."; TargetFields = @("$.revenue","$.employees") },
    @{ Prompt = "Architecture meeting notes describing follow-up actions for vendor evaluation."; TargetFields = @("$.notes") }
)
