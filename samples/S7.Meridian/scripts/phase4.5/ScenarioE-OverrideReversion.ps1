...
$sourcePrompts = @(
    @{ Prompt = "Meeting notes documenting architecture evaluation steps and next actions."; TargetFields = @("$.notes") },
    @{ Prompt = "Vendor questionnaire responses highlighting revenue, staffing, and certifications."; TargetFields = @("$.revenue","$.employees") }
)
