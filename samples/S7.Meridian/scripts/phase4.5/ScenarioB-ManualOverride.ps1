...
$sourcePrompts = @(
    @{ Prompt = "Meeting notes covering vendor evaluation discussions for enterprise architecture."; TargetFields = @("$.notes") },
    @{ Prompt = "Vendor questionnaire capturing revenue figures, employee counts, and service capabilities."; TargetFields = @("$.revenue","$.employees") }
)
