...
REM Simple: rebuild everything and spin up the stack, then open web URL if applicable
set "ROOT=%~dp0"
pushd "%ROOT%" >nul

set "PROJECT_NAME=koan-s16-pantrypal"
set "COMPOSE_FILE=docker-compose.yml"
set "OPEN_URL=http://localhost:8080"
...
REM Best-effort open for web samples
