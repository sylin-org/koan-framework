...
{
    public static async Task EnsureSampleData(ILogger logger, CancellationToken cancellationToken = default)
    {
        ...
        var sensorBed1Serial = "sensor-bed-1";
        ...
        var sensorBed2Serial = "sensor-bed-2";
        ...
        var sensorBed3Serial = "sensor-bed-3";
