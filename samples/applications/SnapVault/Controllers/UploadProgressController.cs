...
/// layer, so the endpoint follows the application's composed tenant isolation rather than adding a controller gate.
/// In a tenancy app under the
...
/// <c>Koan.Identity.Tenancy</c> context contributor sets the ambient). In the dev-open posture it
