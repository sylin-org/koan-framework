...
- Koan capabilities restore from nuget.org. Only the example foundation is packed locally by
  the verifier. Read exact packages and recipes from the current
