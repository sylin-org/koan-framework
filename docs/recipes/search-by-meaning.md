...
This controller is the same `Client.Embed` + `Vector<T>.Search` shape used by the compiled
[GardenCoop search controller](https://github.com/sylin-org/koan-framework/blob/main/samples/journeys/GardenCoop/02-LocalDiscovery/Controllers/ProduceSearchController.cs).
