...
| [R04-02](work-items/r04/R04-02-host-scoped-runtime.md) | P0 | in-progress | Repeated hosts/tests cannot inherit disposed providers or registrations. | R04-01 | canonical leases, provider-owned aggregate configuration, scoped startup, and binder-owned testing helpers are green; logging/error residuals remain |
