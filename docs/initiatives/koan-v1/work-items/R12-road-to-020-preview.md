...
| R12-02 — close preview-blocking seams | Storage activation, remote configuration provenance, AI lifetime, reflective capability bridges, misleading Backup encryption, and other accepted concerns receive fix/remove/exclude decisions | pending |
