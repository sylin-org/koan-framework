...
| 2026-07-13 | R04-07 | A pillar-first review could have placed every Koan capability on Entity, recreating the IntelliSense clutter the contract rejects. | Elect `Cache`, `AI`, and narrowly constrained `Media` as module facets; retain direct intrinsic Data/Events language and constrained Canon/Storage verbs; keep control-plane, projection, messaging, and job surfaces off generic Entity. Cache remains the one-facet pilot after R04-02/R04-05. |
