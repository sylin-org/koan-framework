...
| R04 | active | R04-01 passed; R04-02 is in progress with host binding, vector confirmation, AI discovery, lifecycle capture ownership, equal-delegate composition, startup probing, scheduler activation, and orchestrator child shutdown isolated. |
