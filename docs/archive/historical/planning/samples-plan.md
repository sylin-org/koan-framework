...
- S4 GraphQL Client: Client (Alpine.js or React+urql) + API (GraphQL via Koan.Web.Connector.GraphQl)
...
- API: enable Koan.Web.Connector.GraphQl alongside REST; queries:
