...
> on 2026-06-20 (.NET 10, Docker, Ollama). The final app is six files: [`app/`](../../../case-studies/agent-wedge-demo/app). Nothing is
...
checked-in [`koan.lock.json`](../../../case-studies/agent-wedge-demo/app) emitted at build, P1.1) name every module it's composed of:
...
The final source: [`app/`](../../../case-studies/agent-wedge-demo/app).
