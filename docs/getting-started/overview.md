...
await todo.Remove();
// Provider-bounded on SQLite/Postgres/SQL Server/Cockroach/Mongo/Couchbase; others reject.
await foreach (var t in Todo.AllStream(batchSize: 1000)) { /* consumer-paced pages */ }
```
