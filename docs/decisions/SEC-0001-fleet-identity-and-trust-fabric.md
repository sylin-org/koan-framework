...
**Status**: **Accepted (2026-06-06)** — positions ratified by the architect. Founds the **`Koan.Security.Trust`** pillar. **Extends and supersedes DEC-0053** (completes the inbound half it deferred; replaces its deterministic-secret/HS256 dev model with asymmetric signing) — DEC-0053 marked *Superseded by SEC-0001*. Implementation underway: Phase 0 (return-URL fix, §10) + Phase 1 (asymmetric signing, §11) first; Phases 2–7 (§17) sequenced thereafter.
**Date**: 2026-06-06
