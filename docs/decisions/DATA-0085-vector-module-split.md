...
> **Related: see DATA-0060 (Vector module split and clean separation).** Both ADRs cover the same decision domain — splitting vector functionality out of `Koan.Data.Core` into a dedicated `Koan.Data.Vector` module; read them together.
