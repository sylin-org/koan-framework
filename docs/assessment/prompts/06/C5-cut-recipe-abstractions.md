# C5 · Cut Koan.Recipe.Abstractions + Observability
...
_Instantiated from CUT-TEMPLATE · row C5._

```text
TASK: cut the project(s) Koan.Recipe.Abstractions + Koan.Recipe.Observability.
JUSTIFICATION (verify, then cite in your summary): Superseded bootstrap idiom (ARCH-0046→ARCH-0086); AppDomain-scan anti-pattern..
...
3. fold ObservabilityRecipe's AddHealthChecks + resilient HttpClient (~10 lines) into Koan.Web's registrar first — read ObservabilityRecipe.cs and port exactly what it does..
