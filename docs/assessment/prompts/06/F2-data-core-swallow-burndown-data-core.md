# F2-data-core · Swallow burn-down: Koan.Data.Core/AdapterConnectionResolver.cs

> **Source**: docs/assessment/06-prompt-stash.md · Track F — fail-loud boot · **Tier**: T2 · **Depends on**: F1
...
_Instantiated from F2-TEMPLATE._
...
THIS SESSION'S PROJECT: Koan.Data.Core/AdapterConnectionResolver.cs (the silent config-typo fallthrough — class (c): a malformed setting value must at minimum LogWarning)
```
