...
```text
TASK: cut the project(s) Koan.Data.Cqrs + src/Connectors/Data/Cqrs (Mongo outbox).
JUSTIFICATION (verify, then cite in your summary): Zero consumers/tests; superseded by Jobs ledger outbox (JOBS-0005).
