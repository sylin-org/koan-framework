...
/// 1) Env connection string (Koan_TESTS_MONGO or MONGO_CONNECTION_STRING)
...
public sealed class MongoAutoFixture : IAsyncLifetime
{
    ...
    {
        // 1) Env
        var env = Environment.GetEnvironmentVariable("Koan_TESTS_MONGO")
    ...
    private void BuildServices()
    {
        ...
        var dbName = "Koan-test-" + Guid.NewGuid().ToString("n");
