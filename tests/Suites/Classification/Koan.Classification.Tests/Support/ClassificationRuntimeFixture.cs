...
/// the classified-field registry and registers the field-transform contributor. Proves classification through real
...
internal sealed class ClassificationRuntimeFixture : IAsyncDisposable
{
    ...
    public static async Task<ClassificationRuntimeFixture> CreateAsync(IReadOnlyDictionary<string, string?>? extra = null)
    {
