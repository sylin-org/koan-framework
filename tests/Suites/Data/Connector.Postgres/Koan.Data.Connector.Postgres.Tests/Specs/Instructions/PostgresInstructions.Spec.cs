...
public sealed class PostgresInstructionsSpec(PostgresFixture fixture, ITestOutputHelper output)
    : KoanDataSpec<PostgresFixture>(fixture, output)
{
    ...
    public async Task Instruction_clear_returns_deleted_count()
    {
        ...
        (await InstructionProbe.Count.Exact()).Should().Be(1);
        ...
        (await InstructionProbe.Count.Exact()).Should().Be(0);
    }
