...
/// <summary>
/// ARCH-0101 §3 — the container-name particle plane proven end-to-end on the real DuckDB adapter (real
...
/// </summary>
public sealed class StorageNameParticleNoLeakSpec(DuckDbFixture fixture, ITestOutputHelper output)
    : KoanDataSpec<DuckDbFixture>(fixture, output), IDisposable
{
    ...
    [Fact(DisplayName = "DuckDb: a separate-container name-particle axis isolates each tenant's rows by physical container")]
