...
public sealed class ConformanceOwnershipProbeRegistrar : IKoanAutoRegistrar
{
    ...
    public string ModuleName => "Koan.Testing.Tests.ConformanceOwnershipProbe";
    public string? ModuleVersion => typeof(ConformanceOwnershipProbeRegistrar).Assembly.GetName().Version?.ToString();
