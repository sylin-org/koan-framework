...
namespace Koan.Samples.GardenCoop.Tests;

public sealed class GardenCoopGoldenPathSpec(GardenCoopFixture fixture) : IClassFixture<GardenCoopFixture>
{
    ...
    public async Task Fresh_host_explains_and_executes_the_complete_garden_story()
    {
        ...
        factsJson.Should().Contain("Sylin.g1c1.GardenCoop");
