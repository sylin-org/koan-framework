...
using GardenCoopEmbedded.Initialization;
using Koan.Core;
...
public sealed class GardenCoopEmbeddedFixture : IAsyncLifetime
{
    private readonly string _dataDirectory = Path.Combine(
        Path.GetTempPath(),
        "koan-gardencoop-embedded-tests",
    ...
    {
        _ = typeof(GardenCoopEmbeddedModule);
