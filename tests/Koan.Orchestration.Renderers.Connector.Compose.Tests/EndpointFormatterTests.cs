...
namespace Koan.Orchestration.Renderers.Connector.Compose.Tests;
...
public class EndpointFormatterTests
{
    ...
    public void Plan_hint_uses_expected_scheme_with_image_or_port(string? image, int containerPort, string scheme)
    {
        ...
        var hint = Koan.Orchestration.Cli.Formatting.EndpointFormatter.GetPlanHint(imageOrSvc, containerPort, 4242);
