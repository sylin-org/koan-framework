...
public class TypedFlowTests
{
    ...
    {
        var dir = Path.Combine(Path.GetTempPath(), "Koan-flow-tests", Guid.CreateVersion7().ToString("n"));
    ...
    public async Task Identity_On_Miss_Issues_Uuid_And_Creates_Provisional_Link()
    {
        ...
        var payload = new Dictionary<string, object?>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            [$"{Koan.Flow.Infrastructure.Constants.Reserved.IdentifierExternalPrefix}default"] = env.ExternalRef
        };
